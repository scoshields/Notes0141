    ...
    <form onSubmit={handleSubmit} className="w-full space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 text-lg font-semibold text-gray-700">
          ...
          <h2>{noteType === 'assessment' ? 'Clinical Assessment' : 'Clinical Notes'}</h2>
        </div>
        <button
          type="button"
          onClick={handleClear}
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="Enter any additional instructions for AI to use while processing your note..."
          disabled={isProcessing}
        />
      </div>
      ...
      >
        {isProcessing ? 'Processing...' : `Generate ${noteType === 'assessment' ? 'Clinical Assessment' : 'Clinical Notes'}`}
      </button>
    </form>
  );
}